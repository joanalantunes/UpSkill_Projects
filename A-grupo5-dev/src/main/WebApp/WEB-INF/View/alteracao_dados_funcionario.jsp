...
<div class="main">
    ...
    <div class="retangulodados">
        <form method="POST" action="/alteracao_dados_funcionario/${user.getId()}" enctype="multipart/form-data">
            <br>
                 <div class="wrapper">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input ttype="contacto" name="contacto" class="form-control" id="inputContacto" placeholder="Contacto telefónico" value="${user.getContacto()}">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="inputEmail" class="form-control" id="inputEmail" placeholder="${user.getEmail()}" value="${user.getEmail()}" readonly>
                </div>
            </div>
            <br>
