...
<div class="main">
    ...
    <br>
     <div class="retangulodados">
         <form method="POST" action="/alteracao_dados_medico/${user.getId()}" enctype="multipart/form-data">
              <br>
                 <div class="wrapper">
             ...
             <div class="row">
                 <div class="form-group col-md-6">
                     ...
                     <select id="inputDocId" class="form-control" id="inputDocumentoId">
                         ...
                         <option>Número de cédula</option>
                     </select>
                 </div>
                 <div class="form-group col-md-6">
             ...
             <div class="row">
                 ...
                 <div class="form-group col-md-6">
                     ...
                     <select id="inputEspecialidade" class="form-control" id="inputEspecialidade">
                        <option selected>Selecione...</option>
