   ...
   <div class="textocalendario">
    ...
    <div class="retangulocentral">
        ...
        <div class="form-group col-sm-3" style="margin-left: 2%">
             <label>Selecionar Médico/Especialista</label>
                <select id="inputMedico" class="form-control">
                     <option value="">Escolha Médico/Especialista</option>
                     <c:forEach var="medico" items="${medicoList}">
        ...
        <div class = buttonsubmeter>
            <button type="submit" class="btn-special btn-lg" href="inicio">Escolher data</button>
        </div>
        </form>
    </div>
    <div class="noticias">
