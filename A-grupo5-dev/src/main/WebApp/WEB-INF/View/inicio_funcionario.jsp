    ...
    <div class="main">
        ...
        <div class="card2">
            <div class="boxChamada">
                <div class="ChamarUtente">REGISTO DE CHEGADA UTENTE</div>
                <div class="numeroUtente">Introduza o NIF do utente</div>
                <div class="nrUtente">
                    <input type="number" id="nrUtente" name="nrUtente" placeholder="NIF"></div>
                <br>
                <style>
            .button {
            }
            .button1 {background-color: transparent;}
                ...
                <button class="button button1">SUBMETER</button>
