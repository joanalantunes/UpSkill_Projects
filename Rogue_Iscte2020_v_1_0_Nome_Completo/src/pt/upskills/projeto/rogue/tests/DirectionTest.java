...
public class DirectionTest {
	...
	public void testAsVector() {
		...
		//assertEquals(Direction.RIGHT_UP.asVector(), new Vector2D(1,-1));
		//assertEquals(Direction.RIGHT_DOWN.asVector(), new Vector2D(1,1));
		//assertEquals(Direction.LEFT_UP.asVector(), new Vector2D(-1,-1));
		//assertEquals(Direction.LEFT_DOWN.asVector(), new Vector2D(-1,1));
	}
